...
class TestTree(unittest.TestCase):
    ...
    def test_serialization(self):
        ...
        expected = "t1\x05123,,0,11,6,1,1e-07,25\x07{'img': '1241241313.png'}\x06n1*[None,inf,inf,0\x080\x07[root,1.0,1628400570.8713503,0\x0817\x07{'name': 'itree'}[math,2.0,16284000.0,0\x0832\x07{'age': 10, 'memory': (1, 2, 3)}[music,3.0,4.0,0\x0838\x07{'location': [1, 2, 3], 'price': 12.3}]][music,122840057.8713503,1228400500.0,0\x080\x07][music,32840057.8713503,628400500.0,0\x080\x07[egg,3284.8713503,6284500.0,0\x080\x07[icecream,32843.8713503,62845003.0,0\x080\x07[pizza,32843.8713503,62845003.0,0\x080\x07]]]][piggy,3284.8713503,6284500.0,0\x080\x07[unicorn,32843.8713503,62845003.0,0\x080\x07[monkey,32843.8713503,62845003.0,0\x080\x07]]]]]"
    ...
    def test_deserialization(self):
        ...
        d1 = "t1\x05123,,0,11,6,1,1e-07,25\x07{'img': '1241241313.png'}\x06n1*[None,inf,inf,0\x080\x07[root,1.0,1628400570.8713503,0\x0817\x07{'name': 'itree'}[math,2.0,16284000.0,0\x0832\x07{'age': 10, 'memory': (1, 2, 3)}[music,3.0,4.0,0\x0838\x07{'location': [1, 2, 3], 'price': 12.3}]][music,122840057.8713503,1228400500.0,0\x080\x07][music,32840057.8713503,628400500.0,0\x080\x07[egg,3284.8713503,6284500.0,0\x080\x07[icecream,32843.8713503,62845003.0,0\x080\x07[pizza,32843.8713503,62845003.0,0\x080\x07]]]][piggy,3284.8713503,6284500.0,0\x080\x07[unicorn,32843.8713503,62845003.0,0\x080\x07[monkey,32843.8713503,62845003.0,0\x080\x07]]]]]"
        tree.deserialize(d1)
